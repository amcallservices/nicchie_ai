      ...
      <div className="w-full max-w-md">
        ...
        <div className="p-8 rounded-xl border border-zinc-800 bg-zinc-900/80 backdrop-blur-xl">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Benvenuto</h1>
            <p className="text-sm text-zinc-400">Accedi al tuo account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-zinc-400">Ricordami</span>
              </label>
