...
import { Sparkles, Eye, EyeOff, User, Mail, Lock, Check } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-cyan-500">
        ...
        {/* Card */}
        <div className="p-8 rounded-xl border border-zinc-800 bg-zinc-900/80 backdrop-blur-xl">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Crea il tuo account</h1>
            <p className="text-sm text-zinc-400">Inizia a trovare nicchie profittevoli</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-2 space-y-1">
                  {passwordRequirements.map((req, index) => (
                    <div key={index} className="flex items-center gap-2 text-xs">
                      <div className={`w-4 h-4 rounded-full flex items-center justify-center ${req.met ? 'bg-emerald-500' : 'bg-zinc-700'}`}>
            ...
            <label className="flex items-start gap-2 cursor-pointer text-sm">
              <input type="checkbox" className="mt-1 rounded border-zinc-700 bg-zinc-800" required />
              <span className="text-zinc-400">
                Accetto i{' '}
                <Link href="/terms" className="text-violet-400 hover:text-violet-300">Termini di servizio</Link>
                {' '}e la{' '}
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-zinc-900 px-2 text-zinc-500">oppure</span>
              </div>
            </div>
